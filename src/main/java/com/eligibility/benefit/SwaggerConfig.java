...
public class SwaggerConfig {
	...
	public Docket postsApi() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("")
		 ...
		 .paths(Predicates.not(PathSelectors.regex("/sampleRest/.*")))
	...
	/*private Predicate<String> postPaths() {
		...
		return or(regex("/api/posts.*"), regex("/sampleRest/.*"));
	...
	private ApiInfo metaData() {
        ApiInfo apiInfo = new ApiInfo(
        		"Demo REST API",
                "This is a Demo API created for BookMySeat",
                "1.0",
                "API Terms of Service URL",
                 new Contact("Saiprasad", "localhost:8090/", "Restcall"),
