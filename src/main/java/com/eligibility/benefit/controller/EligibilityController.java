...
public class EligibilityController {
    ...
    public ResponseEntity<Object> getBenefit(
            @RequestHeader HttpHeaders headers, @RequestParam String subscriberId, @RequestParam String dependentId,
        ...
        return ResponseHandlingUtil.prepareResponse(eligibilityService.getEligibility(subscriberId, dependentId,
                                                                                      policyId, token.get(0)));
